...
GENOME=<NAME>
RUNTYPE=${GENOME}_RM
DIR=/lustre/scratch/aosmansk/RayLib-Masking/results2/$RUNTYPE
LIBRARYPATH=/lustre/scratch/aosmansk/RayLib-Masking/200Mammal-RayLib-20210618/final_mammal_library_06221021.fa
GENOMEPATH=/lustre/scratch/aosmansk/rm_zoonomia/assemblies
...
python /home/daray/gitrepositories/bioinfo_tools/slurm_clusterrun.py \
        -i ${GENOME}.fa \
        -b 10 \
        -lib $LIBRARYPATH \
        -dir . \
